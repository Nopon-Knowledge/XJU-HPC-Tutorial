...
高算平台提供多个 Python 和 CUDA 模块，也可以通过清华镜像在线创建其他 Python 版本并安装项目依赖。

Python 版本、CUDA 和深度学习项目依赖的完整配置流程请查看：[深度学习项目依赖环境配置教程](documents/深度学习项目依赖环境配置教程.md)

## 三、作业调度系统命令

一切都配置好后，现在可以开始使用高算平台了，高算平台有自己的一套作业命令，请进入下方链接查看。
